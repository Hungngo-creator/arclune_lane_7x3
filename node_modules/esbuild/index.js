...
function loadTypeScript(){
  ...
  try {
    ...
    try {
      ...
      cachedTypescript = require(resolved);
      return cachedTypescript;
    } catch (err2){
      const installHint = 'TypeScript loader requires the "typescript" package. Please run "npm install" (or install devDependencies) before building.';
      const error = new Error(installHint);
      error.cause = err2 ?? err;
      throw error;
    }
  }
}
