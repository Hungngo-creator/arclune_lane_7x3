...
__define('./art.js', (exports, module, __require) => {
  ...
  function getPalette(id){
    ...
    return (function (_temp){ return _temp == null ? void 0 : _temp.palette; })(art) || basePalettes.default;
  }
...
__define('./combat.js', (exports, module, __require) => {
  ...
  function basicAttack(Game, unit){
    ...
    const tgt = (function (){ var _temp = Statuses.resolveTarget(unit, pool, { attackType: 'basic' }); return _temp != null ? _temp : fallback; })();
    if (!tgt) return;
...
__define('./engine.js', (exports, module, __require) => {
  ...
  function makeGrid(canvas, cols, rows){
    ...
    const h = Math.max(
      Math.floor(w * ((function (){ var _temp = (function (_temp){ return _temp == null ? void 0 : _temp.BOARD_H_RATIO; })(CFG.UI); return _temp != null ? _temp : (3/7); })())),
      (function (){ var _temp = (function (_temp){ return _temp == null ? void 0 : _temp.BOARD_MIN_H; })(CFG.UI); return _temp != null ? _temp : 220; })()
    );
  ...
  function drawQueuedOblique(ctx, g, queued, cam){
   ...
   const C = cam || { rowGapRatio: 0.62, topScale: 0.80, depthScale: 0.94 };
   const baseR = Math.floor(g.tile * 0.36);
   const k = (function (){ var _temp = C.depthScale; return _temp != null ? _temp : 0.94; })();

   function drawSide(map, side){
    if (!map) return;
     // Ally thấy theo SHOW_QUEUED; enemy ẩn trừ khi bật SHOW_QUEUED_ENEMY
    if (side === 'ally'  && !((function (_temp){ return _temp == null ? void 0 : _temp.SHOW_QUEUED; })(CFG.DEBUG))) return;
     if (side === 'enemy' && !((function (_temp){ return _temp == null ? void 0 : _temp.SHOW_QUEUED_ENEMY; })(CFG.DEBUG))) return;
...
__define('./entry.js', (exports, module, __require) => {
  ...
  (function bootstrap(){
    ...
    const protocol = (function (_temp){ return _temp == null ? void 0 : _temp.protocol; })((function (_temp){ return _temp == null ? void 0 : _temp.location; })(window));
...
__define('./meta.js', (exports, module, __require) => {
  ...
  const Meta = {
    get: getMetaById,
    classOf(id){ return (function (){ var _temp = (function (_temp){ return _temp == null ? void 0 : _temp.class; })(this.get(id)); return _temp != null ? _temp : null; })(); },
    rankOf(id){  return (function (){ var _temp = (function (_temp){ return _temp == null ? void 0 : _temp.rank; })(this.get(id)); return _temp != null ? _temp : null; })(); },
    kit(id){     return (function (){ var _temp = (function (_temp){ return _temp == null ? void 0 : _temp.kit; })(this.get(id)); return _temp != null ? _temp : null; })(); },
  ...
  function initialRageFor(unitId, opts = {}){
    ...
    if (opts.revive) return Math.max(0, (function (){ var _temp = (function (_temp){ return _temp == null ? void 0 : _temp.rage; })(opts.reviveSpec); return _temp != null ? _temp : 0; })());
    return (function (){ var _temp = onSpawn.rage; return _temp != null ? _temp : 0; })();
  }
...
__define('./summon.js', (exports, module, __require) => {
  ...
  function processActionChain(Game, side, baseSlot, hooks){
    const list = Game.actionChain.filter(x => x.side === side);
     (function (){ var _temp = if (!list.length) return baseSlot; return _temp != null ? _temp : null; })();
    ...
    for (const item of list){
      ...
      (function (_obj){ var _func = _obj.doActionOrSkip; return _func == null ? void 0 : _func.call(_obj, Game, creep, hooks); })(if (creep) hooks);
