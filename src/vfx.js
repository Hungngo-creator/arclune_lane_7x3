...
export function vfxAddLightningArc(Game, source, target, opts = {}) {
  return makeLightningEvent(Game, source, target, opts);
}

export function vfxAddBloodPulse(Game, source, opts = {}) {
...
export function vfxAddShieldWrap(Game, source, opts = {}) {
...
export function vfxAddGroundBurst(Game, source, opts = {}) {
