...
const LEGACY_MODULE_ID_ALIAS_ENTRIES = [
  ...
  ['./modes/pve/session-events.ts', './modes/pve/session-events.ts'],
  ['./modes/pve/session-events/index.js', './modes/pve/session-events.ts'],
  ['./modes/pve/session-events/index.ts', './modes/pve/session-events.ts'],
  ...
  ['./screens/vinh-da/gameplay.js', './screens/vinh-da/gameplay.ts'],
  ...
  ['@modes/pve/session-loop', './modes/pve/session-loop.ts'],
  ['@modes/pve/session-loop.js', './modes/pve/session-loop.ts'],
  ['@modes/pve/session-loop.ts', './modes/pve/session-loop.ts'],
  ['@modes/pve/session-render', './modes/pve/session-render.ts'],
  ['@modes/pve/session-render.js', './modes/pve/session-render.ts'],
  ['@modes/pve/session-render.ts', './modes/pve/session-render.ts'],
  ['@modes/pve/session-render/index.js', './modes/pve/session-render.ts'],
  ['@modes/pve/session-render/index.ts', './modes/pve/session-render.ts'],
  ['@modes/pve/session-events', './modes/pve/session-events.ts'],
  ['@modes/pve/session-events.js', './modes/pve/session-events.ts'],
  ['@modes/pve/session-events.ts', './modes/pve/session-events.ts'],
  ['@modes/pve/session-events/index.js', './modes/pve/session-events.ts'],
  ...
  ['@screens/vinh-da/gameplay.ts', './screens/vinh-da/gameplay.ts'],
  ...
  ['@combat/runtime-hooks/duong-ha.js', './combat/runtime-hooks/duong-ha.ts'],
  ['./combat/runtime-hooks/co-truong-phong.js', './combat/runtime-hooks/co-truong-phong.ts'],
  ['./combat/runtime-hooks/co-truong-phong', './combat/runtime-hooks/co-truong-phong.ts'],
  ['@combat/runtime-hooks/co-truong-phong', './combat/runtime-hooks/co-truong-phong.ts'],
  ['@combat/runtime-hooks/co-truong-phong.ts', './combat/runtime-hooks/co-truong-phong.ts'],
  ['@combat/runtime-hooks/co-truong-phong.js', './combat/runtime-hooks/co-truong-phong.ts'],
